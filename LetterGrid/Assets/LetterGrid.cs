...
public class LetterGrid : MonoBehaviour {
    ...
    string[] Morephabet = {".-.,.", "=", "=,,", "=,-", ".,.-=", "-.-", ".", ",..", "=--=,", ",", "=-,=", ",,.", "--.=", "-----", "-", "==.", ",--=", "-,==", "=.,,", "=====", "=,", ",=", "=.", "-,", ",=-"};
    string[] MorseLetters = {".-", "-...", "-.-.", "-..", ".", "..-.", "--.", "....", "..", "-.-", ".-..", "--", "-.", "---", ".--.", "--.-", ".-.", "...", "-", "..-", "...-", ".--", "-..-", "-.--", "--.."};
    List<string> Sync = new List<string> { "a", "p'", "C", "t'", "e", "f", "k'", "h", "i", "j'", "k", "r'", "m", "n", "o", "p", "?", "r", "s", "t", "u", "f'", "w", "!", "y", "s'" };
      ...
      for (int i = 0; i < 25; i++) {
        if (FontMaterialNumbers[i] < 20) {
          ...
          switch (FontMaterialNumbers[i]) {
            ...
            break;
            case 12: case 13: //necor futhark
            ModuleLetterText[i].text = ModuleLetterText[i].text.ToLower();
            break;
            case 17: // Sync
            ModuleLetterText[i].text = Sync[Alphabet.IndexOf(ModuleLetterText[i].text) + 1];
            break;
            case 19: //zoni
